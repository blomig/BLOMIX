...
Chaque document technique commence par une ligne **Version de référence** alignée sur `MARKETING_VERSION` (actuellement **7.3** en review ; **7.2** en vente). La mettre à jour lors d'une release majeure.
