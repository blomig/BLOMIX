...
Chaque document technique commence par une ligne **Version de référence** alignée sur `MARKETING_VERSION` (actuellement **6.10** en local ; **6.9** en vente). La mettre à jour lors d'une release majeure.
