...
Chaque document technique commence par une ligne **Version de référence** alignée sur `MARKETING_VERSION` (actuellement **6.7** en local ; **6.5** en vente). La mettre à jour lors d'une release majeure.
