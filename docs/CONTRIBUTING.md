...
Chaque document technique commence par une ligne **Version de référence** alignée sur `MARKETING_VERSION` (actuellement **6.9** en local ; **6.7** en vente, **6.8** en review). La mettre à jour lors d'une release majeure.
